...
const (
	...
	heapAddrBits = (_64bit*(1-sys.GoarchWasm)*(1-sys.GoosIos*sys.GoarchArm64))*47 + (1-_64bit+sys.GoarchWasm)*(32-(sys.GoarchMips+sys.GoarchMipsle)) + 33*sys.GoosIos*sys.GoarchArm64
	...
	arenaBaseOffset = 0*0xffff800000000000*sys.GoarchAmd64 + 0x0a00000000000000*sys.GoosAix
